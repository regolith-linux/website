...
The PPA `ppa:regolith-linux/release` is currently hosting Regolith 1.4.1 version packages.  To upgrade an existing system to version 1.4.1, update the package manager to source Regolith packages from the `release` PPA:
